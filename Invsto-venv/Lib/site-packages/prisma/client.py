...
SCHEMA_PATH = Path('E:/Projects/Invsto-Project/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\vedan\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    stockdata: 'actions.StockDataActions[models.StockData]'
    ...
    def __init__(
        ...
        *,
        ...
        self.stockdata = actions.StockDataActions[models.StockData](self, models.StockData)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'E:/Projects/Invsto-Project/prisma/schema.prisma',
        }
...
class Batch:
    stockdata: 'StockDataBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.stockdata = StockDataBatchActions(self)
...
class StockDataBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.StockDataCreateInput,
        include: Optional[types.StockDataInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
    ...
    def create_many(
        self,
        data: List[types.StockDataCreateWithoutRelationsInput],
        *,
    ...
    def delete(
        self,
        where: types.StockDataWhereUniqueInput,
        include: Optional[types.StockDataInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.StockDataUpdateInput,
        where: types.StockDataWhereUniqueInput,
        include: Optional[types.StockDataInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.StockDataWhereUniqueInput,
        data: types.StockDataUpsertInput,
        include: Optional[types.StockDataInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.StockDataUpdateManyMutationInput,
        where: types.StockDataWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.StockData,
    ...
    def delete_many(
        self,
        where: Optional[types.StockDataWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.StockData,
